...
| 駅から通って / 道を通って | えきからとおって / みちをとおって | かよって（同段有「通う」時） | READING_FIXES |
| に行った / 行きます / 行きました | にいった / いきます / いきました | おこなった（收窄成「に行った」，免得誤傷「流行った」） | READING_FIXES |
| 写した / 写しました | うつした / うつしました | しゃ― | READING_FIXES |
| 楽になり | らくになり | たのしく―（收窄，免得誤傷「音楽に」） | READING_FIXES |
...
| と二人で | とふたりで | ににん―。**故意收窄成「と二人で」**，不要寫成通用的「二人で」，否則 boarding-house 已產並聽過的 3 個音檔會無謂重產 | READING_FIXES |
| 開いた / 開きました | ひらいた / ひらきました | あいた／あきました。上面已有「開く」，但它蓋不到活用形 | READING_FIXES |
...
| 電車で三十分 / 三十分ぐらい | さんじゅっぷん… | ぶん（同「五分」）。**預防性**，收窄成 graduation 的兩個片語，避免誤傷 business-trip 已聽過的「三十分だと…」 | READING_FIXES |
| 、二人で | 、ふたりで | ににん（同「と二人で」）。**預防性**，待 audio-check 確認 | READING_FIXES |
